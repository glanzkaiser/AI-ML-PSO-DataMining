%%
% INPUT VARIABLES
% Bird_in_swarm=jumla partikel=agents=candidate
% Number_of_quality_in_Bird=jumlah variabel
%
...
%     f = a+b ;
% end
% Food_availability adlah string
%
...
%{
    check semua parameter digunakan
%}
if nargin < 11
...
%{
	 check batasan nilai dan matriks
%}
