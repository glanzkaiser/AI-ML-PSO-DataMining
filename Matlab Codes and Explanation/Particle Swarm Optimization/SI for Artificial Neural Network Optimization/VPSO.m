...
% particle swarm optimization (PSO) adalah metode komputasional 
% yg optimasi masalah dg menaikkan kandidat
% solusi dg memberikan kualitas ukuran
% PSO memberikan solusi dg mempunyai sebuag populasi
% partikel, bergerak diantara the search-space 
% dg formula mtk melewati posisi partikel
% dan kecepatan. tiap partikel bergerak 
% di posisiny dg posisi terbaik
% di search-space, yg posisi terbaik didapat 
% di partikel lain. itulah cara swarm memberikan solusi terbaik
%
% -----------------------------------
